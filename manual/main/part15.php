<div class="p-3 pl-5 mb-2 bg-secondary text-white">Компонент</div>

<div class="text-secondary bg-light border font-weight-normal p-1 pl-5 mb-2">Контроллер</div>
<div class="code_block mb-2">
    <ol>
        <li>
            <span class="line_code"><span class="keywords">namespace</span> app\controllers\components;</span>
        </li>
        <li></li>
        <li>
            <span class="line_code"><span class="keywords">use</span> framework\classes\Component;</span>
        </li>
        <li></li>
        <li>
            <span class="line_code"><span class="keywords">class</span> Name* <span class="keywords">extends</span> <span class="class">Component</span> {</span>
        </li>
        <li></li>
        <li class="tab1">
...
<div class="code_block mb-2">
    <ol>
        <li>
            <span class="line_code"><span class="keywords">namespace</span> app\langs\en;</span>
        </li>
        <li>
            <span class="line_code"></span>
        </li>
        <li>
            <span class="line_code"><span class="keywords">use</span> framework\classes\Lang;</span>
        </li>
        <li>
            <span class="line_code"></span>
        </li>
...
<div class="pl-5 mb-3">
    ...
    <br />
    <small class="text-muted">Используйте <code>\framework\classes\NE::langLine('test')</code></small>
</div>