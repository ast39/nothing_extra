...
<div class="col-12 mt-3 mb-3">
    <form method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control" value="<?= Buffer::instance()->name ?>" id="title" name="title" placeholder="new">
        </div>
        <div class="form-group">
            <label for="code"><?= $this->langLine('redactor_edit_form') ?></label>
            <textarea id="code" name="code" class="form-control" rows="16"><?= Buffer::instance()->code ?></textarea>
        </div>
