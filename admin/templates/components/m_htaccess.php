...
<h4 class="mt-3 pl-3"><?= $this->langLine('manage_htaccess_head') ?></h4>
<hr />
...
<?php else: ?>
    <form role="form" method="post">
        <label for="robots" class="pl-3"><?= $this->langLine('manage_edit') ?> .htaccess</label>
        <textarea id="robots" name="robots" class="form-control" rows="16"><?= Buffer::instance()->data ?></textarea>
