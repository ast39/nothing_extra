<?php
    use framework\classes\{Session, Route, Url};
?>
                ...
                <?php foreach ($this->buffer->list['files'] as $k => $v):?>
                    <tr class="row">
                        ...
                        <td class="text-right col-sm-2">
                            ...
                            <?php if ($v['type'] != 'img'): ?>
                                <img class="img-thumbnail" style="cursor: pointer" alt="edit" src="<?= Url::img('system/i_edit.png') ?>" width="32" onclick="window.location.href='<?= SITE ?>redactor/editfile/<?= Session::get('conductor_url') . $v['name'] ?>'" />
                            <?php endif; ?>
                            <img class="img-thumbnail" style="cursor: pointer" alt="delete" src="<?= Url::img('system/i_delete.png') ?>" width="32"
